...
class Data:
    ...
    def read_data_from_dict(self, data: dict):
        ...
        self.max_trips_per_train = data["num_trips"]
        ...
        self.initial_point = data["initial_point"]
        ...
        aux_min = data["service_time_min"]
        aux_max = data["service_time_max"]
