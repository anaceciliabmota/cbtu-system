...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Visual scheduling studio for rail lines and train timetables." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Railplan — Sistema de Planejamento Ferroviário" },
      { property: "og:description", content: "Design corridors, routes, fleets and demand periods, then generate timetables." },
